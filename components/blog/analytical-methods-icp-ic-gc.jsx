  ...
  return (
    <div className="prose prose-lg max-w-none">
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ICP is used for <strong>elemental analysis</strong>, specifically determining which metals and other elements are present in a sample and at what concentration. It can detect dozens of elements simultaneously, from major constituents down to trace levels in the parts-per-billion (μg/L) or even parts-per-trillion (ng/L) range. Common applications include metals in drinking water, heavy metals in soil, elemental composition of industrial products, and nutrient analysis in fertilisers (phosphorus, potassium, calcium, magnesium, etc.).
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <div className="bg-gray-50 border border-gray-200 p-5 my-6">
        ...
        <ul className="text-gray-700 space-y-1 text-sm list-disc pl-4">
          ...
          <li>Matrix matching of calibrants to samples is important, as dissolved solids and acids affect the signal</li>
        </ul>
      </div>
      ...
      <ol className="list-decimal pl-6 mb-6 text-gray-700 space-y-3">
        ...
        <li>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li><strong>FID (Flame Ionisation Detector):</strong> the most common. The eluting compounds are burned in a hydrogen/air flame, producing ions that create a measurable current. Responds to almost all organic compounds; very sensitive with a wide linear range.</li>
            <li><strong>MS (Mass Spectrometer):</strong> GC-MS is the gold standard. Each compound is fragmented and its mass spectrum compared to a library, giving positive identification rather than just a retention time. Essential for unknown identification and confirmation.</li>
      ...
      <div className="bg-gray-50 border border-gray-200 p-5 my-6">
        ...
        <ul className="text-gray-700 space-y-1 text-sm list-disc pl-4">
          ...
          <li>Water is generally incompatible with FID (damages the flame), so samples are often extracted into an organic solvent first</li>
          <li>GC-MS allows library matching for positive identification; FID alone only gives a retention time</li>
          <li>Column choice matters: non-polar columns (e.g. 5% phenyl polysiloxane) separate by boiling point; polar columns also separate by polarity</li>
      ...
      <div className="space-y-6 mb-12">
        <div className="border-l-4 border-gray-400 pl-6">
          ...
          <p className="text-gray-700">
            Argon is chemically inert (it won&apos;t react with the sample or torch), it ionises relatively easily to sustain the plasma, and it has a high enough ionisation energy that most analyte elements ionise more readily than the argon itself, which keeps the plasma stable. Helium plasmas exist but are much less common.
          </p>
        </div>
